...
<style>
    ...
    .infopag {background-image: url(img/contactofor.png);
        text-align: center;
    ...
    <div class="container">
        <img class="imag" src="{{asset('img/plantilla.jpg')}}" alt="">
    </div><br>
    ...
    <br><div class="container formcontact">
        <div class="row afterfor">
            ...
            <div class="infopag col-xl-6 col-lg-4 col-md-2">
                <br><a href="https://www.facebook.com/" target="_blank "><img class="imgredes" width="150px" height="150px" src="{{asset('img/redespagcel.png')}}" alt=""></a>
                ...
                <br><a href="https://www.whatsapp.com/?lang=es" target="_blank" ><img width="55px" height="55px" src="{{asset('img/iconwhatsapp.png')}}" ><strong>Asesoria inmediata</strong></a>
            </div>
        </div>
